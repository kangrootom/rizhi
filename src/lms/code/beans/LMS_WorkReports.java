...
public class LMS_WorkReports   {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "S_LMS_WorkReports")
	@SequenceGenerator(name = "S_LMS_WorkReports", allocationSize = 1, initialValue = 1, sequenceName = "S_LMS_WorkReports")
