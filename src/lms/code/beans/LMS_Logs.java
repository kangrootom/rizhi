...
public class LMS_Logs {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "S_LMS_Logs")
	@SequenceGenerator(name = "S_LMS_Logs", allocationSize = 1, initialValue = 1, sequenceName = "S_LMS_Logs")
	private long logID;
