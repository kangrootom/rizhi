...
public class WorkReportDao extends AbstractDao{
	...
	public final String GetLogInfo = " from LMS_Logs l where l.manager.staffID = {0} and l.startTime >= to_date('{1}','yy-mm-dd') and to_date(to_char(l.endTime,'yyyy-mm-dd'),'yyyy-mm-dd') <= to_date('{2}','yy-mm-dd')";
