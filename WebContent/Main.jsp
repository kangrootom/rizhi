...
<script type="text/javascript" src="<%=SiteConfig.DoMain%>js/Modal.Windows.LogManage.js"></script>
...
<script type="text/javascript" src="<%=SiteConfig.DoMain%>js/Modal.Windows.ReportManage.js"></script>
<script type="text/javascript" src="<%=SiteConfig.DoMain%>js/Modal.Windows.ProjectManage.js"></script>
	...
	<div class="header">
		...
		<div class="headmenu">
			<ul class="nav nav-pills">
				<li><a  id="btnMsgCenter" href="#"><i class="icon-envelope icon-white"></i><span>消息中心</span>
				</a>
				</li>
